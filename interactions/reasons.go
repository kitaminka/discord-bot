...
var (
	Reasons = []Reason{
		...
		{
			Name:        "Нарушение правил форумов",
			Description: "**Вы опубликовали в форуме пост, который нарушает его правила или тематику форума** Просьба соблюдать правила форума.",
		},
	}
